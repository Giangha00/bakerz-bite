      ...
      <div className="au-commitment-row">
        ...
        <div className="au-commitment-cards">
          <div className="au-commitment-card">
            ...
            <div className="au-commitment-card-desc">We source only the finest ingredients, including real butter, fresh cream, and unbleached flour for exceptional taste and quality.</div>
          </div>
          <div className="au-commitment-card">
            <div className="au-commitment-card-title">Freshness Promise</div>
            <div className="au-commitment-card-desc">All our products are made fresh daily in-store, ensuring you get the best taste and quality with every visit.</div>
          </div>
          <div className="au-commitment-card">
            <div className="au-commitment-card-title">Customer Care</div>
            <div className="au-commitment-card-desc">We treat every customer like family and are committed to providing exceptional service and products you can trust.</div>
          </div>
        </div>
      </div>
    </section>

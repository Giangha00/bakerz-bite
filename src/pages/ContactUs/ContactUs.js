        ...
        <div className="cu-left-col cu-center-col">
          <div className="cu-card cu-contact-card">
            ...
            <div className="cu-info-row">
              ...
              <div>
                <span className="cu-info-label">Hours</span>
                <br />
                <span className="cu-info-value">
          ...
          <div className="cu-card cu-map-card">
            ...
            <div className="cu-map-box">
              <span className="cu-map-icon">
                <FontAwesomeIcon icon={faMapMarkerAlt} style={mapIconStyle} />
              </span>
              <div className="cu-map-desc">
                Interactive Map
                <br />
                123 Bakery Street, Downtown, NY
              </div>
            </div>
          </div>
        </div>
